...
// Serial Console Messages
	...
	#define MSG_M115_REPORT "LEAPFROG_FIRMWARE:" LEAPFROG_FIRMWARE_VERSION " MACHINE_TYPE:" LEAPFROG_MODEL " PROTOCOL_VERSION:" PROTOCOL_VERSION " FIRMWARE_NAME:Marlin V1"
