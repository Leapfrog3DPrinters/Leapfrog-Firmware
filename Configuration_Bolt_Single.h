...
#define DISABLE_E true // there are some new funtions in the new version of Merlin
 #define INVERT_X0_DIR true    // for Creatr PRO set to true
...
#define INVERT_E0_DIR true   // fo BOLT! single to true
...
#define X_MIN_POS 0
#define Y_MIN_POS 0  //0 original
#define Z_MIN_POS 0
#define X_MAX_POS 380
#define Y_MAX_POS 350      //350 original
#define Z_MAX_POS 180
 // The position of the homing switches. Use MAX_LENGTH * -0.5 if the center should be 0, 0, 0
#define X_HOME_POS X_MIN_POS // Switch to MIN_POS for single config
...
#define EXTRUDER_OFFSET_X {0.0} // (in mm) for each extruder, offset of the hotend on the X axis
